...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <a href="/" className="absolute top-6 left-6 text-gray-400 hover:text-dark transition-colors flex items-center gap-2 z-20">
        <ArrowLeft size={20} />
                    ...
                    <div className="w-full space-y-8 animate-fade-in-up">
                        ...
                        <div className="pt-4 border-t border-gray-50">
                            <p className="text-[10px] text-gray-400 text-center leading-relaxed font-medium">
                                Нажимая на кнопку входа, вы принимаете условия <a href="/blog/terms" target="_blank" className="text-gold hover:underline font-bold">Оферты</a> и даете согласие на обработку данных согласно <a href="/blog/policy" target="_blank" className="text-gold hover:underline font-bold">Политике конфиденциальности</a>.
                            </p>
                        </div>
                    </div>
                )}
