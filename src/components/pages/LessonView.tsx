...
import { Article, UserProfile } from '../../types/index';
        ...
        <div className="min-h-screen bg-white">
            ...
            <header className="bg-dark text-white p-3 md:p-4 sticky top-0 z-30 shadow-lg">
                <div className="container mx-auto max-w-5xl flex items-center justify-between">
                    <a href="/learning" className="flex items-center gap-1.5 text-gray-400 hover:text-white transition-colors text-sm md:text-base">
