      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-4xl mx-auto text-sm text-gray-400 mb-12 text-left md:text-center">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="/author/roman-tretiakov" className="hover:text-gold transition-colors flex items-center h-7 md:justify-center">
                  О нас
                </a>
              </li>
              <li><a href="/blog" className="hover:text-gold transition-colors flex items-center h-7 md:justify-center">Блог</a></li>
              <li>
                <button 
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="/blog/policy" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition-colors flex items-center h-7 md:justify-center">
                  Политика конфиденциальности
                </a>
              </li>
              <li>
                <a href="/blog/terms" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition-colors flex items-center h-7 md:justify-center">
