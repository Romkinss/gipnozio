...
import ConsultationsTab from '../components/admin/tabs/ConsultationsTab';
import QuizzesTab from '../components/admin/tabs/QuizzesTab';
import SurveysTab from '../components/admin/tabs/SurveysTab';
