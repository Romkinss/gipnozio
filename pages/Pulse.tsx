                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="flex flex-wrap gap-4">
                                                                {isExternal ? (
                                                                    ...
                                                                    <Link to={`/blog/${item.slug}`} className="inline-flex items-center gap-2 bg-gray-100 text-dark px-6 py-2.5 rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-gold transition-all">Подробнее <ChevronRight size={16} /></Link>
                                                                )}
                                                                {isPast && !isExternal && (
                            ...
                            <div className="sticky top-40 space-y-8">
                                {upcomingEvent && (
                                    <div className="bg-white rounded-3xl p-6 border border-gold/30 shadow-lg shadow-gold/5 relative overflow-hidden">
                                        ...
                                        <Link to={upcomingEvent.external_url ? upcomingEvent.external_url : `/blog/${upcomingEvent.slug}`} className="block w-full py-3 bg-dark text-white rounded-xl text-xs font-bold uppercase tracking-widest text-center hover:bg-gold hover:text-dark transition-all">Участвовать</Link>
                                    </div>
                                )}
