    ...
    <>
      <header className="bg-dark-accent text-white py-6 border-b-2 border-gold relative z-50">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-6">
          <Link to="/" className="w-24 h-24 bg-dark-accent rounded-lg shadow-[0_0_15px_rgba(212,175,55,0.3)] overflow-hidden flex items-center justify-center border border-gold/30">
            <img 
          ...
          <div className="text-center md:text-left">
            <Link to="/" className="text-2xl md:text-3xl font-serif font-bold tracking-wider text-white hover:text-gold transition-colors">
