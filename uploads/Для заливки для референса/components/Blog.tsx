                ...
                {loading ? (
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {articles.map((article) => (
                            <Link key={article.id} to={`/blog/${article.slug}`} className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-gold transition-all duration-300 border border-gray-100 flex flex-col h-full transform hover:-translate-y-1">
                                {article.featuredImage ? (
                                    ...
                                    <div className="h-56 bg-gradient-to-br from-gold/10 to-gold/5 flex items-center justify-center relative">
                                        ...
                                        <Feather size={48} className="text-gold opacity-20" />
                                    </div>
                                )}
                                <div className="p-6 flex flex-col flex-grow">
                                    <h3 className="text-xl font-bold text-dark mb-3 group-hover:text-gold transition-colors line-clamp-2 font-serif">
                                        {article.title}
                                    </h3>
